    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          {loading ? (
            <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-3 sm:gap-4 md:gap-6 lg:gap-6 xl:gap-5 2xl:gap-4">
              {[...Array(10)].map((_, i) => (
                <div key={i} className="bg-white rounded-2xl sm:rounded-3xl shadow p-3 sm:p-4 lg:p-5 xl:p-4 flex flex-col items-center animate-pulse min-h-[300px] sm:min-h-[340px] lg:min-h-[380px] xl:min-h-[360px]">
